...
(function () {
	...
	function getElementUsingTagname(ele, val) {
		...
		document.querySelectorAll("#collapseBgGradient .form-check input").forEach(function (subElem) {
		...
		document.querySelectorAll("[name='data-sidebar']").forEach(function (elem) {
